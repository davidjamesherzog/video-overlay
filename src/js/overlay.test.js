...
describe('overlay', () => {
  ...
  describe('constructor', () => {
    ...
    test('should set time update', () => {
      ...
      expect(overlay['startEvent_']).toEqual('timeupdate');
    });

    test('should set player event', () => {
      options.start = 'play';
      overlay = new Overlay(player, options);
      expect(overlay['startEvent_']).toEqual('play');
    });
  ...
  describe('functions', () => {
    ...
    describe('hide', () => {
      ...
      test('should add class and event listener', () => {
        ...
        overlay.hide();
        expect(overlay.el_.classList.add).toHaveBeenCalledWith('video-hidden');
    ...
    describe('show', () => {
      ...
      test('should remove class and event listener', () => {
        overlay.show();
        expect(overlay.el_.classList.remove).toHaveBeenCalledWith('video-hidden');
